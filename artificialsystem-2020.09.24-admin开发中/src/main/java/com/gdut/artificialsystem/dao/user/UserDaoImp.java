package com.gdut.artificialsystem.dao.user;

import com.gdut.artificialsystem.dao.user.UserDao;
...
public class UserDaoImp implements UserDao {
    ...
    public Msg selectLastPrimaryKey(){
        ...
        try {
            ...
            return new Msg("last_user_id",result);

        }catch (Exception e){
            return new Msg("sql error",null);
        }
